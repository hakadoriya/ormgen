...
const SelectForUpdateUserByPKQuery = `SELECT user_id, username, address, group_id FROM user WHERE user_id = $1 FOR UPDATE`
...
const SelectForUpdateUserByUsernameQuery = `SELECT user_id, username, address, group_id FROM user WHERE username = $1 FOR UPDATE`
...
const SelectForUpdateUserByUsernameAndAddressQuery = `SELECT user_id, username, address, group_id FROM user WHERE (username = $1 AND address = $2) FOR UPDATE`
...
const SelectForUpdateAdminUserByPKQuery = `SELECT admin_user_id, username, group_id FROM admin_user WHERE admin_user_id = $1 FOR UPDATE`
