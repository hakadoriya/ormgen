...
type GenerateConfig struct {
	...
	GoORMStructPackageImport string `cli:"go-orm-struct-package-import-path, env=ORMGEN_GO_ORM_STRUCT_PACKAGE_IMPORT_PATH,                      description=package import path of ORM target struct. If empty, try to detect automatically."`
